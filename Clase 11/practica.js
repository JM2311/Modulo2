...
//   const prodEncontrado = listaDeProductosSeleccionados.includes(
//     texto.toLowerCase()
//   );
...
// // console.log(listaDeProductosSeleccionados);
// const buscarProductoConfirm = confirm("Desea buscar un producto seleccionado?");
// if (buscarProductoConfirm) {
//   let productoABuscar = prompt("Ingrese el producto a buscar : ");
//   const resultado = buscarProducto(productoABuscar);
